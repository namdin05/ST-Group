...
All values originate from the scenario raw JSON and summary files. Endurance additionally includes a clean final Summary screenshot and an exact-hold machine-readable analysis. This mapping follows the assignment's k6-equivalent interpretation: the primary analytical perspective differs by scenario even though the preserved HTML artifacts share one genuine exporter shell. It does not claim that renaming identical views would make them distinct.
