...
$Host.UI.RawUI.WindowTitle = "HW05 Spike Resource Evidence - $Phase"
$state = Get-Content -Raw -LiteralPath $StatePath | ConvertFrom-Json
$started = [datetimeoffset]::Parse($state.spikeStartedAt)
...
Clear-Host
Write-Host 'HW05 - LIVE SPIKE RESOURCE EVIDENCE' -ForegroundColor Cyan
...
Write-Host 'k6 PID is the active 1-to-25-VU Spike generator.'
