...
- Name: fr13-dashboard.spec.ts >> FR-13 – Dashboard >> UI cases >> TC009 – minimum positive revenue and count are displayed
- Location: tests\fr13-dashboard.spec.ts:413:11

# Error details

```
Error: money value should settle at 1 ₫

money value should settle at 1 ₫
