...
- Name: fr13-dashboard.spec.ts >> FR-13 – Dashboard >> UI cases >> TC004 – large delivered revenue is not truncated
- Location: tests\fr13-dashboard.spec.ts:413:11

# Error details

```
Error: money value should settle at 1000000000 ₫

money value should settle at 1000000000 ₫
  ...
  - generic [ref=e15]:
    ...
    - generic [ref=e17]:
      - generic [ref=e18]:
        ...
        - paragraph [ref=e20]: 2,000,000,000 ₫
      - generic [ref=e21]:
