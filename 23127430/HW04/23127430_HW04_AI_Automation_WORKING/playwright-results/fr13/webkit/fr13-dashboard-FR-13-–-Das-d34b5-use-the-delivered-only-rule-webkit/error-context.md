...
- Name: fr13-dashboard.spec.ts >> FR-13 – Dashboard >> UI cases >> TC010 – all supported statuses use the delivered-only rule
- Location: tests\fr13-dashboard.spec.ts:413:11

# Error details

```
Error: money value should settle at 100000 ₫

money value should settle at 100000 ₫
