...
- Name: fr07-shopping-cart.spec.ts >> FR-07 – Shopping Cart >> UI cases >> TC002 – empty cart shows message, illustration, and shopping link
- Location: tests\fr07-shopping-cart.spec.ts:248:9

# Error details

```
Error: Empty state should include a semantic illustration
