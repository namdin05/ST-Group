...
- Name: fr01-registration.spec.ts >> FR-01 – Account Registration >> API cases >> TC016 – duplicate email is rejected without overwriting the account
- Location: tests\fr01-registration.spec.ts:339:9

# Error details

```
Error: TC016 should return a client error
