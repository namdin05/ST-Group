...
- Name: fr01-registration.spec.ts >> FR-01 – Account Registration >> API cases >> TC010 – missing name is rejected and creates no account
- Location: tests\fr01-registration.spec.ts:296:9

# Error details

```
Error: TC010 should return a client error
...
```
Error: TC010 must not create a login-capable account
