...
- Name: fr01-registration.spec.ts >> FR-01 – Account Registration >> API cases >> TC014 – seven-character password is rejected and creates no account
- Location: tests\fr01-registration.spec.ts:322:9

# Error details

```
Error: TC014 should return a client error
...
```
Error: TC014 must not create a login-capable account
