...
- Name: fr01-registration.spec.ts >> FR-01 – Account Registration >> API cases >> TC011 – missing email is rejected
- Location: tests\fr01-registration.spec.ts:303:9

# Error details

```
Error: TC011 should return a client error
