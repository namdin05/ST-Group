...
- Name: fr07-shopping-cart.spec.ts >> FR-07 – Shopping Cart >> UI cases >> TC010 – continue-shopping control returns to the home page
- Location: tests\fr07-shopping-cart.spec.ts:386:9

# Error details

```
Error: Non-empty cart requires the reviewed control label
...
Call log:
  - Non-empty cart requires the reviewed control label with timeout 5000ms
...
Received: "http://localhost:5173/cart"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="en">…</html>
       - unexpected value "http://localhost:5173/cart"
