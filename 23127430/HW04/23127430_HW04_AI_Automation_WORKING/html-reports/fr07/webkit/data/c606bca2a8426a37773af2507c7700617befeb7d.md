...
- Name: fr07-shopping-cart.spec.ts >> FR-07 – Shopping Cart >> API cases >> TC012 – API merges duplicate product posts into one line
- Location: tests\fr07-shopping-cart.spec.ts:413:9
...
Expected length: 1
Received length: 2
Received array:  [{"id": 1, "name": "Laptop Gaming Pro", "price": 100000, "quantity": 1}, {"id": 1, "name": "Laptop Gaming Pro", "price": 100000, "quantity": 1}]
```
