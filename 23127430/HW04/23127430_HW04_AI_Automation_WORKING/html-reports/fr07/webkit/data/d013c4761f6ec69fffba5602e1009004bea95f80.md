...
- Name: fr07-shopping-cart.spec.ts >> FR-07 – Shopping Cart >> UI cases >> TC007 – grand total sums all line totals and uses the exact label
- Location: tests\fr07-shopping-cart.spec.ts:326:9

# Error details

```
Error: Grand-total label must match FR-07 exactly

expect(locator).toBeVisible() failed

Locator: locator('main').getByText(/^Tổng cộng:/)
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Grand-total label must match FR-07 exactly with timeout 5000ms
  - waiting for locator('main').getByText(/^Tổng cộng:/)
  ...
  - table:
    ...
    - rowgroup:
      - row "Laptop Gaming Pro 100,000 ₫ 2 200,000 ₫ Xóa":
        ...
        - cell "Xóa":
          - button "Xóa"
      - row "Wireless Mouse 50,000 ₫ 3 150,000 ₫ Xóa":
        - cell "Wireless Mouse"
        - cell "50,000 ₫"
        - cell "3"
        - cell "150,000 ₫"
