...
- Name: fr01-registration.spec.ts >> FR-01 – Account Registration >> API cases >> TC012 – missing password is rejected
- Location: tests\fr01-registration.spec.ts:309:9

# Error details

```
Error: TC012 should return a client error
